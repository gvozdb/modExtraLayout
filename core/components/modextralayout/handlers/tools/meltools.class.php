...
class melTools
{
     ...
     * @return bool
     */
    public function systemMapExtends(array $map = array())
    {
    ...
    public function prepareResponse($response)
    {
        ...
        if ($this->mel->config['jsonResponse'] AND is_array($output)) {
            $output = $this->modx->toJSON($output);
        } elseif (!$this->mel->config['jsonResponse'] AND !is_array($output)) {
